    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_outside:
                    "day-outside text-slate-400 dark:text-slate-500 aria-selected:bg-slate-100/50 dark:aria-selected:bg-slate-800/50 aria-selected:text-slate-400 dark:aria-selected:text-slate-500",
