...
const pwdMismatch =
  pwd.length > 0 && pwd2.length > 0 && pwd !== pwd2;
        ...
        <section className="flex-1 rounded-xl p-4  flex flex-col gap-6 justify-center items-center">
          <div className="min-h-screen bg-white text-neutral-800 flex items-start justify-center p-6">
            <div className="w-full max-w-sm">
                ...
                <form action="./signin" method="post" className="mt-5 space-y-4">
                {/* Name pair */}
                ...
                <div className="mt-1 flex gap-2">
                    ...
                    <button
                    type="button"
                    className="h-11 rounded-lg border border-[var(--color-border)] bg-white px-3
                                inline-flex items-center gap-2 text-sm hover:bg-neutral-50"
                    // onClick={() => openCountryPicker()}  // ถ้าจะทำ picker จริง ๆ
                    >
                    {/* TH flag (svg) */}
                ...
                <span className="leading-6">
                    I agree to the{" "}
                    <a href="/terms" className="text-[var(--color-primary)] underline underline-offset-2">
                    terms of service
                    </a>{" "}
                    and{" "}
                    <a href="/privacy" className="text-[var(--color-primary)] underline underline-offset-2">
                    privacy policy
                    </a>.
                </span>
                </label>
